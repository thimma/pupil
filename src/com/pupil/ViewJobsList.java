...
/**
 * Servlet implementation class ViewJobsList
 */
@WebServlet("/ViewJobsList")
public class ViewJobsList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Job> jobsList = getJobsList.getJobsList(request, response, (Connection)getServletContext().getAttribute("conn"));
